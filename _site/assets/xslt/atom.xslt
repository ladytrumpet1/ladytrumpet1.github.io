...
<xsl:template match="/atom:feed">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> G&#39;Day Travelers</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="G&#39;Day Travelers – Your next adventure starts now">
				<img src="http://localhost:4000/assets/img/gdaytravellers-logo1-nobackground.png" alt="G&#39;Day Travelers – Your next adventure starts now">
			</a>
